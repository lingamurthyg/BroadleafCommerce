...
/**
 * JUnit 5 test class for CheckUpdateAvailabilityActivity
 * Auto-generated test suite
 */
public class CheckUpdateAvailabilityActivityTest {

    private CheckUpdateAvailabilityActivity instance;

    @BeforeEach
    public void setUp() {
        // Initialize test instance
        // instance = new CheckUpdateAvailabilityActivity();
    }
    ...
    public void testConstructor() {
        // CheckUpdateAvailabilityActivity obj = new CheckUpdateAvailabilityActivity();
        // assertNotNull(obj);
