...
/**
 * JUnit 5 test class for FulfillmentGroupMerchandiseTotalActivity
 * Auto-generated test suite
 */
public class FulfillmentGroupMerchandiseTotalActivityTest {

    private FulfillmentGroupMerchandiseTotalActivity instance;

    @BeforeEach
    public void setUp() {
        // Initialize test instance
        // instance = new FulfillmentGroupMerchandiseTotalActivity();
    }
    ...
    public void testConstructor() {
        // FulfillmentGroupMerchandiseTotalActivity obj = new FulfillmentGroupMerchandiseTotalActivity();
        // assertNotNull(obj);
