...
/**
 * JUnit 5 test class for AddFulfillmentGroupItemActivity
 * Auto-generated test suite
 */
public class AddFulfillmentGroupItemActivityTest {

    private AddFulfillmentGroupItemActivity instance;

    @BeforeEach
    public void setUp() {
        // Initialize test instance
        // instance = new AddFulfillmentGroupItemActivity();
    }
    ...
    public void testConstructor() {
        // AddFulfillmentGroupItemActivity obj = new AddFulfillmentGroupItemActivity();
        // assertNotNull(obj);
