...
/**
 * JUnit 5 test class for UpdateOrderMultishipOptionActivity
 * Auto-generated test suite
 */
public class UpdateOrderMultishipOptionActivityTest {

    private UpdateOrderMultishipOptionActivity instance;

    @BeforeEach
    public void setUp() {
        // Initialize test instance
        // instance = new UpdateOrderMultishipOptionActivity();
    }
    ...
    public void testConstructor() {
        // UpdateOrderMultishipOptionActivity obj = new UpdateOrderMultishipOptionActivity();
        // assertNotNull(obj);
