...
/**
 * JUnit 5 test class for RemoveOrderMultishipOptionActivity
 * Auto-generated test suite
 */
public class RemoveOrderMultishipOptionActivityTest {

    private RemoveOrderMultishipOptionActivity instance;

    @BeforeEach
    public void setUp() {
        // Initialize test instance
        // instance = new RemoveOrderMultishipOptionActivity();
    }
    ...
    public void testConstructor() {
        // RemoveOrderMultishipOptionActivity obj = new RemoveOrderMultishipOptionActivity();
        // assertNotNull(obj);
